...
const searchClient = () => {
    ...
    const filteredClients = dbClient.filter(client =>
        ...
        client.celular.includes(searchValue) ||
        client.cidade.toLowerCase().includes(searchValue)
    )
    clearTable()
    filteredClients.forEach(createRow)
}
...
const clearTable = () => {
    const row = document.querySelectorAll('#tbClient>tbody tr')
...
document.getElementById('search')
    .addEventListener('input', searchClient)
